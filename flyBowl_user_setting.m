...
camera(1).port = 5010;
defaultJsonFile(1).name = 'C:\Users\labadmin\Documents\MATLAB\FlyBowl4\bias_config_default1.json';
...
camera(2).port = 5020;
defaultJsonFile(2).name = 'C:\Users\labadmin\Documents\MATLAB\FlyBowl4\bias_config_default2.json';
...
camera(3).port = 5030;
defaultJsonFile(3).name = 'C:\Users\labadmin\Documents\MATLAB\FlyBowl4\bias_config_default3.json';
...
camera(4).port = 5040;
defaultJsonFile(4).name = 'C:\Users\labadmin\Documents\MATLAB\FlyBowl4\bias_config_default4.json';
...
expDataDir = 'E:\ToMove';
%file settings
defaultDir = 'C:\Users\labadmin\Documents\MATLAB\FlyBowl4\';
