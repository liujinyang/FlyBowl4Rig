...
% Last Modified by GUIDE v2.5 06-Apr-2022 15:25:34
...
if button_state == get(hObject,'Max')
    ...
    for i = 1:4
        if ~(handles.hComm.flea3{i} == 0) && handles.hComm.flea3IsActive(i)
            ...
            jsonFile = [handles.(['expDataSubdir',num2str(i)]), '\cameraSettings', num2str(i),'.json'];
            ...
            %fprintf(handles.expTimeFileID, '%.10f , start camera %d recording.\n', now, i);
        end
    end
...
set(findall(handles.chooseBowlPanel, '-property', 'enable'), 'enable', 'on');
...
set(handles.load_flies_btn3, 'enable', 'on');
set(handles.load_flies_btn4, 'enable', 'on');
...
% --- Executes on button press in bowl1_checked.
function bowl1_checked_Callback(hObject, eventdata, handles)
% hObject    handle to bowl1_checked (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of bowl1_checked
chooseBowl1 = get(hObject,'Value');
if chooseBowl1
    handles.hComm.flea3IsActive(1) = true;
    flyBowl_camera_control(handles.hComm.flea3(1),'preview');
    handles.flyBowlEnabled{1} = true;
    handles.hComm.LEDCtrl.flyBowlsEnabled('setValue',handles.flyBowlEnabled);
    handles.hComm.LEDCtrl.setIRLEDPower(handles.IrIntValue);
    handles.hComm.LEDCtrl.setRedLEDPower(handles.Chr_int_val);
    handles.hComm.LEDCtrl.setGrnLEDPower(handles.Grn_int_val);
    handles.hComm.LEDCtrl.setBluLEDPower(handles.Blu_int_val)
else
    handles.hComm.flea3IsActive(1) = false;
    handles.flyBowlEnabled{1} = false;
    handles.hComm.LEDCtrl.flyBowlsEnabled('setValue',handles.flyBowlEnabled);
    pause(0.2);
...
% --- Executes on button press in bowl3_checked.
function bowl3_checked_Callback(hObject, eventdata, handles)
% hObject    handle to bowl3_checked (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of bowl3_checked
chooseBowl3 = get(hObject,'Value');
if chooseBowl3
    handles.hComm.flea3IsActive(3) = true;
    flyBowl_camera_control(handles.hComm.flea3(3),'preview');
    handles.flyBowlEnabled{3} = true;
    handles.hComm.LEDCtrl.flyBowlsEnabled('setValue',handles.flyBowlEnabled);
    handles.hComm.LEDCtrl.setIRLEDPower(handles.IrIntValue);
    handles.hComm.LEDCtrl.setRedLEDPower(handles.Chr_int_val);
    handles.hComm.LEDCtrl.setGrnLEDPower(handles.Grn_int_val);
    ...
    handles.hComm.flea3IsActive(3) = false;
    handles.flyBowlEnabled{3} = false;
    handles.hComm.LEDCtrl.flyBowlsEnabled('setValue',handles.flyBowlEnabled);
    pause(0.2);
    flyBowl_camera_control(handles.hComm.flea3(3),'stop');
end
guidata(hObject, handles);
end


% --- Executes on button press in bowl2_checked.
function bowl2_checked_Callback(hObject, eventdata, handles)
% hObject    handle to bowl2_checked (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of bowl2_checked
chooseBowl2 = get(hObject,'Value');
if chooseBowl2
    handles.hComm.flea3IsActive(2)  = true;
    flyBowl_camera_control(handles.hComm.flea3(2),'preview');
    handles.flyBowlEnabled{2} = true;
    handles.hComm.LEDCtrl.flyBowlsEnabled('setValue',handles.flyBowlEnabled);
    handles.hComm.LEDCtrl.setIRLEDPower(handles.IrIntValue);
    handles.hComm.LEDCtrl.setRedLEDPower(handles.Chr_int_val);
    handles.hComm.LEDCtrl.setGrnLEDPower(handles.Grn_int_val);
    ...
    handles.hComm.flea3IsActive(2)  = false;
    handles.flyBowlEnabled{2} = false;
    handles.hComm.LEDCtrl.flyBowlsEnabled('setValue',handles.flyBowlEnabled);
    pause(0.2);
    flyBowl_camera_control(handles.hComm.flea3(2),'stop');
    
end
guidata(hObject, handles);
end

% --- Executes on button press in bowl4_checked.
function bowl4_checked_Callback(hObject, eventdata, handles)
% hObject    handle to bowl4_checked (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of bowl4_checked
chooseBowl4 = get(hObject,'Value');
if chooseBowl4
    handles.hComm.flea3IsActive(4)  = true;
    flyBowl_camera_control(handles.hComm.flea3(4),'preview');
    handles.flyBowlEnabled{4} = true;
    handles.hComm.LEDCtrl.flyBowlsEnabled('setValue',handles.flyBowlEnabled);
    handles.hComm.LEDCtrl.setIRLEDPower(handles.IrIntValue);
    handles.hComm.LEDCtrl.setRedLEDPower(handles.Chr_int_val);
    handles.hComm.LEDCtrl.setGrnLEDPower(handles.Grn_int_val);
    ...
    handles.hComm.flea3IsActive(4)  = false;
    handles.flyBowlEnabled{4} = false;
    handles.hComm.LEDCtrl.flyBowlsEnabled('setValue',handles.flyBowlEnabled);
    pause(0.2);
    flyBowl_camera_control(handles.hComm.flea3(4),'stop');
end
guidata(hObject, handles);
end
